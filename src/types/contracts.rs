...
pub const CALIBRATION_ID: &str = "calibration2.aea4.testnet";
pub const CHOICE_ID: &str = "choice2.aea4.testnet";
pub const CONTRACT_REGISTRY_ID: &str = "contract2.aea4.testnet";
pub const COURT_ID: &str = "court2.aea4.testnet";
pub const DAO_FACTORY_ID: &str = "dao6.aea4.testnet";
pub const FT_FACTORY_ID: &str = "ft2.aea4.testnet";
pub const FT_MINT_ID: &str = "mint1.aea4.testnet";
pub const FT_SALE_FACTORY_ID: &str = "sale1.aea4.testnet";
pub const ROLE_ID: &str = "role2.aea4.testnet";
pub const HUMANITY_ID: &str = "humanity1.aea4.testnet";
pub const MARKETPLACE_ID: &str = "marketplace1.aea4.testnet";
pub const NFT_ID: &str = "nft4.aea4.testnet";
...
pub const PROPOSAL_ID: &str = "proposal2.aea4.testnet";
pub const STAKING_FACTORY_ID: &str = "staking3.aea4.testnet";
pub const SUBSCRIPTION_ID: &str = "subscription1.aea4.testnet";
pub const TOKEN_ID: &str = "aea1.ft2.aea4.testnet";
pub const VALUE_ID: &str = "value2.aea4.testnet";
